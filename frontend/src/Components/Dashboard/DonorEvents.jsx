...
import { deleteEvent } from '../../operations/eventApi';
    ...
    <div className="p-8">
      ...
      {!events ? (
        ...
        <div className="overflow-x-auto">
          {/* Headings */}
          <div className="grid grid-cols-6 bg-gray-800 text-white rounded-t-lg p-4 border-b-2 border-white bg-richblack-700">
            ...
            <p className="col-span-1 text-center font-semibold">Actions</p>
          </div>
          {/* Event Rows */}
          {events.map((event, i) => (
            <div
              className={`grid grid-cols-6 items-center border-b border-white p-4 hover:bg-gray-100 transition bg-richblack-700`}
              key={i}
            >
              <div
              ...
              <div className="col-span-1 text-center text-white text-sm flex justify-center gap-4">
              <FaRegEdit />
              <RiDeleteBin6Line/>
              </div>
            </div>
